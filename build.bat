...
REM ========================================
echo [2/8] Building SGAtom v%ATOM_VERSION% (onedir)...
...
REM ========================================
echo [3/8] Building SOAPProxy v%PROXY_VERSION% (onedir)...
...
REM ========================================
REM Step 4: Build gen_license
REM ========================================
echo [4/8] Building gen_license.exe...
pushd "%ATOM_PROJECT_DIR%"
...
REM ========================================
echo [5/8] Creating output structure...
mkdir "%OUTPUT_DIR%" 2>nul
mkdir "%OUTPUT_DIR%\runtime" 2>nul

echo [6/8] Copying executables...
