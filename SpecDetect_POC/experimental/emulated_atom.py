...
def build_streamsrc_frame_434(spectrum_data: list,
    ...
    # bytes 29-30 encode frame_channels=417 (0x01A1 in little-endian: [0xA1, 0x01])
    # bytes 31-34 encode start_index=1024 (0x0400 in little-endian: [0x00, 0x04, 0x00, 0x00])
    private_metadata_434 = bytes([
        0xa1, 0x01, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00,
        0x80, 0xe8, 0x54, 0xa0, 0x41, 0x00, 0x00, 0x00,
        0x30, 0xc5, 0xda, 0xa1, 0x41, 0x00, 0x00, 0x00,
